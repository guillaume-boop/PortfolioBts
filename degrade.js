...
function drawRight() {
    ...
    if (finishedRight) {
      for (let square of squares) {
        ...
        setTimeout(drawLeft, 100); // Une fois que le carré mobile à droite a terminé son animation, commencez à dessiner vers la gauche
    }
}
...
function drawLeft() {
    ...
    if (finishedLeft) {
        ...
        if (disparaitLeft) {
            setTimeout(shiftSquaresToLeft, 100);
        }
    }
